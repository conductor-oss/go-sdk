...
// Canonical metric names. Emitted alongside the legacy names above during
// Phase 1 of the SDK metrics harmonization. These are the names that will
// remain after deprecation of the legacy names in a future major release.
const (
