...
func (o *EnumValueDescriptorProtoOrBuilder) GetAllFields() map[string]interface{} {
	if o == nil {
...
func (o *EnumValueDescriptorProtoOrBuilder) GetAllFieldsOk() (*map[string]interface{}, bool) {
...
func (o *EnumValueDescriptorProtoOrBuilder) SetAllFields(v map[string]interface{}) {
	o.AllFields = v
}
