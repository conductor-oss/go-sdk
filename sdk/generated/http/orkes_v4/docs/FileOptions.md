...
`func (o *FileOptions) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *FileOptions) UnsetAllFields()`
...
`func (o *FileOptions) SetAllFieldsRawNil(b bool)`

 SetAllFieldsRawNil sets the value for AllFieldsRaw to be an explicit nil

### UnsetAllFieldsRaw
`func (o *FileOptions) UnsetAllFieldsRaw()`
