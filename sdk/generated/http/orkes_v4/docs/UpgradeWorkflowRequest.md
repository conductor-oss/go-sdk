...
------------ | ------------- | ------------- | -------------
**Name** | **string** |  | 
**TaskOutput** | Pointer to  |  | [optional] 
...
`func (o *UpgradeWorkflowRequest) SetTaskOutputNil(b bool)`

 SetTaskOutputNil sets the value for TaskOutput to be an explicit nil

### UnsetTaskOutput
`func (o *UpgradeWorkflowRequest) UnsetTaskOutput()`

UnsetTaskOutput ensures that no value is present for TaskOutput, not even an explicit nil
### GetVersion
...
`func (o *UpgradeWorkflowRequest) SetWorkflowInputNil(b bool)`

 SetWorkflowInputNil sets the value for WorkflowInput to be an explicit nil

### UnsetWorkflowInput
`func (o *UpgradeWorkflowRequest) UnsetWorkflowInput()`
