...
`func NewExtendedWorkflowDef(tasks []WorkflowTask, timeoutSeconds int64, ) *ExtendedWorkflowDef`
...
`func (o *ExtendedWorkflowDef) SetInputTemplateNil(b bool)`

 SetInputTemplateNil sets the value for InputTemplate to be an explicit nil

### UnsetInputTemplate
`func (o *ExtendedWorkflowDef) UnsetInputTemplate()`
...
`func (o *ExtendedWorkflowDef) SetMetadataNil(b bool)`

 SetMetadataNil sets the value for Metadata to be an explicit nil

### UnsetMetadata
`func (o *ExtendedWorkflowDef) UnsetMetadata()`
...
`func (o *ExtendedWorkflowDef) HasName() bool`
...
`func (o *ExtendedWorkflowDef) SetOutputParametersNil(b bool)`

 SetOutputParametersNil sets the value for OutputParameters to be an explicit nil

### UnsetOutputParameters
`func (o *ExtendedWorkflowDef) UnsetOutputParameters()`
...
`func (o *ExtendedWorkflowDef) SetVariablesNil(b bool)`

 SetVariablesNil sets the value for Variables to be an explicit nil

### UnsetVariables
`func (o *ExtendedWorkflowDef) UnsetVariables()`
