...
`func (o *FieldOptions) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *FieldOptions) UnsetAllFields()`
...
`func (o *FieldOptions) SetAllFieldsRawNil(b bool)`

 SetAllFieldsRawNil sets the value for AllFieldsRaw to be an explicit nil

### UnsetAllFieldsRaw
`func (o *FieldOptions) UnsetAllFieldsRaw()`
