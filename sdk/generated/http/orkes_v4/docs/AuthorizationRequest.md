...
------------ | ------------- | ------------- | -------------
**Access** | **[]string** |  | 
**Subject** | [**SubjectRef**](SubjectRef.md) | User, group or role which is granted/removed access | 
**Target** | [**TargetRef**](TargetRef.md) | The object over which access is being granted or removed | 
