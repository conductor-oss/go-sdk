...
`func (o *ServiceDescriptorProtoOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *ServiceDescriptorProtoOrBuilder) UnsetAllFields()`
...
`func (o *ServiceDescriptorProtoOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *ServiceDescriptorProtoOrBuilder) UnsetDefaultInstanceForType()`
