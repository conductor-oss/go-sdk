...
`func (o *ServiceOptions) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *ServiceOptions) UnsetAllFields()`
...
`func (o *ServiceOptions) SetAllFieldsRawNil(b bool)`

 SetAllFieldsRawNil sets the value for AllFieldsRaw to be an explicit nil

### UnsetAllFieldsRaw
`func (o *ServiceOptions) UnsetAllFieldsRaw()`
