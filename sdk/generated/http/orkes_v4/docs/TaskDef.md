...
`func NewTaskDef(timeoutSeconds int64, totalTimeoutSeconds int64, ) *TaskDef`
...
`func (o *TaskDef) SetInputTemplateNil(b bool)`

 SetInputTemplateNil sets the value for InputTemplate to be an explicit nil

### UnsetInputTemplate
`func (o *TaskDef) UnsetInputTemplate()`
