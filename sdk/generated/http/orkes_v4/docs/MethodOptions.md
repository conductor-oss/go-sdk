...
`func (o *MethodOptions) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *MethodOptions) UnsetAllFields()`
...
`func (o *MethodOptions) SetAllFieldsRawNil(b bool)`

 SetAllFieldsRawNil sets the value for AllFieldsRaw to be an explicit nil

### UnsetAllFieldsRaw
`func (o *MethodOptions) UnsetAllFieldsRaw()`
