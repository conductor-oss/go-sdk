...
`func (o *EnumValueDescriptorProtoOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *EnumValueDescriptorProtoOrBuilder) UnsetAllFields()`
...
`func (o *EnumValueDescriptorProtoOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *EnumValueDescriptorProtoOrBuilder) UnsetDefaultInstanceForType()`
