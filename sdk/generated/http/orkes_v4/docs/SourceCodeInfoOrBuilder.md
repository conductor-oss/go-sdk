...
`func (o *SourceCodeInfoOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *SourceCodeInfoOrBuilder) UnsetAllFields()`
...
`func (o *SourceCodeInfoOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *SourceCodeInfoOrBuilder) UnsetDefaultInstanceForType()`
