...
**ParserForType** | Pointer to  | Simplified schema for ParserDeclaration (original had circular references) | [optional] 
...
`func (o *Declaration) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *Declaration) UnsetAllFields()`
...
`func (o *Declaration) SetParserForTypeNil(b bool)`

 SetParserForTypeNil sets the value for ParserForType to be an explicit nil

### UnsetParserForType
`func (o *Declaration) UnsetParserForType()`

UnsetParserForType ensures that no value is present for ParserForType, not even an explicit nil
### GetRepeated
