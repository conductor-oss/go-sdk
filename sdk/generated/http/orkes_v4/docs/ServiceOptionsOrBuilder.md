...
`func (o *ServiceOptionsOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *ServiceOptionsOrBuilder) UnsetAllFields()`
...
`func (o *ServiceOptionsOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *ServiceOptionsOrBuilder) UnsetDefaultInstanceForType()`
