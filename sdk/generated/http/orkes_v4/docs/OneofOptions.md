...
`func (o *OneofOptions) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *OneofOptions) UnsetAllFields()`
...
`func (o *OneofOptions) SetAllFieldsRawNil(b bool)`

 SetAllFieldsRawNil sets the value for AllFieldsRaw to be an explicit nil

### UnsetAllFieldsRaw
`func (o *OneofOptions) UnsetAllFieldsRaw()`
