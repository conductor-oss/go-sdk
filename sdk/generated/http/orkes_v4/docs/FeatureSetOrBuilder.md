...
`func (o *FeatureSetOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *FeatureSetOrBuilder) UnsetAllFields()`
