...
func main() {
    extendedWorkflowDef := *openapiclient.NewExtendedWorkflowDef([]openapiclient.WorkflowTask{*openapiclient.NewWorkflowTask()}, int64(123)) // ExtendedWorkflowDef | 
...
func main() {
    extendedTaskDef := []openapiclient.ExtendedTaskDef{*openapiclient.NewExtendedTaskDef(int64(123), int64(123))} // []ExtendedTaskDef | 
...
func main() {
    extendedWorkflowDef := []openapiclient.ExtendedWorkflowDef{*openapiclient.NewExtendedWorkflowDef([]openapiclient.WorkflowTask{*openapiclient.NewWorkflowTask()}, int64(123))} // []ExtendedWorkflowDef | 
...
func main() {
    extendedTaskDef := *openapiclient.NewExtendedTaskDef(int64(123), int64(123)) // ExtendedTaskDef | 
