...
**DecisionCases** | Pointer to  |  | [optional] 
**DefaultCase** | Pointer to **interface{}** |  | [optional] 
...
**ForkTasks** | Pointer to **[]interface{}** |  | [optional] 
**InputParameters** | Pointer to  |  | [optional] 
**JoinOn** | Pointer to **[]string** |  | [optional] 
**JoinStatus** | Pointer to **string** |  | [optional] 
**LoopCondition** | Pointer to **string** |  | [optional] 
**LoopOver** | Pointer to **interface{}** |  | [optional] 
**Name** | Pointer to **string** |  | [optional] 
**OnStateChange** | Pointer to  |  | [optional] 
...
`func (o *WorkflowTask) GetDecisionCases() map[string]interface{}`

GetDecisionCases returns the DecisionCases field if non-nil, zero value otherwise.

### GetDecisionCasesOk

`func (o *WorkflowTask) GetDecisionCasesOk() (*map[string]interface{}, bool)`
...
`func (o *WorkflowTask) SetDecisionCases(v map[string]interface{})`
...
`func (o *WorkflowTask) SetDefaultCase(v interface{})`
...
`func (o *WorkflowTask) SetDefaultCaseNil(b bool)`

 SetDefaultCaseNil sets the value for DefaultCase to be an explicit nil

### UnsetDefaultCase
`func (o *WorkflowTask) UnsetDefaultCase()`

UnsetDefaultCase ensures that no value is present for DefaultCase, not even an explicit nil
...
`func (o *WorkflowTask) GetForkTasks() []interface{}`

GetForkTasks returns the ForkTasks field if non-nil, zero value otherwise.

### GetForkTasksOk

`func (o *WorkflowTask) GetForkTasksOk() (*[]interface{}, bool)`
...
`func (o *WorkflowTask) SetForkTasks(v []interface{})`
...
`func (o *WorkflowTask) GetLoopOver() interface{}`

GetLoopOver returns the LoopOver field if non-nil, zero value otherwise.

### GetLoopOverOk

`func (o *WorkflowTask) GetLoopOverOk() (*interface{}, bool)`
...
`func (o *WorkflowTask) SetLoopOver(v interface{})`
...
`func (o *WorkflowTask) SetLoopOverNil(b bool)`

 SetLoopOverNil sets the value for LoopOver to be an explicit nil

### UnsetLoopOver
`func (o *WorkflowTask) UnsetLoopOver()`

UnsetLoopOver ensures that no value is present for LoopOver, not even an explicit nil
### GetName
...
`func (o *WorkflowTask) GetOnStateChange() map[string]interface{}`

GetOnStateChange returns the OnStateChange field if non-nil, zero value otherwise.

### GetOnStateChangeOk

`func (o *WorkflowTask) GetOnStateChangeOk() (*map[string]interface{}, bool)`
...
`func (o *WorkflowTask) SetOnStateChange(v map[string]interface{})`
...
`func (o *WorkflowTask) SetOnStateChangeNil(b bool)`

 SetOnStateChangeNil sets the value for OnStateChange to be an explicit nil

### UnsetOnStateChange
`func (o *WorkflowTask) UnsetOnStateChange()`

UnsetOnStateChange ensures that no value is present for OnStateChange, not even an explicit nil
### GetOptional
...
`func (o *WorkflowTask) HasTaskReferenceName() bool`
