...
**SpanList** | Pointer to **interface{}** |  | [optional] 
...
`func (o *LocationOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *LocationOrBuilder) UnsetAllFields()`
...
`func (o *LocationOrBuilder) GetSpanList() interface{}`

GetSpanList returns the SpanList field if non-nil, zero value otherwise.

### GetSpanListOk

`func (o *LocationOrBuilder) GetSpanListOk() (*interface{}, bool)`
...
`func (o *LocationOrBuilder) SetSpanList(v interface{})`
...
`func (o *LocationOrBuilder) SetSpanListNil(b bool)`

 SetSpanListNil sets the value for SpanList to be an explicit nil

### UnsetSpanList
`func (o *LocationOrBuilder) UnsetSpanList()`

UnsetSpanList ensures that no value is present for SpanList, not even an explicit nil
### GetTrailingComments
