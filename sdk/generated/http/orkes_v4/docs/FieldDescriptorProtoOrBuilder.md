...
`func (o *FieldDescriptorProtoOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *FieldDescriptorProtoOrBuilder) UnsetAllFields()`
...
`func (o *FieldDescriptorProtoOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *FieldDescriptorProtoOrBuilder) UnsetDefaultInstanceForType()`
