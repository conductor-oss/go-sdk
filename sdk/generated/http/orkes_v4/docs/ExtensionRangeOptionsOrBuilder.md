...
`func (o *ExtensionRangeOptionsOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *ExtensionRangeOptionsOrBuilder) UnsetAllFields()`
...
`func (o *ExtensionRangeOptionsOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *ExtensionRangeOptionsOrBuilder) UnsetDefaultInstanceForType()`
