...
**SubWorkflowTestRequest** | Pointer to  |  | [optional] 
**TaskRefToMockOutput** | Pointer to  |  | [optional] 
...
`func (o *WorkflowTestRequest) SetInputNil(b bool)`

 SetInputNil sets the value for Input to be an explicit nil

### UnsetInput
`func (o *WorkflowTestRequest) UnsetInput()`
...
### SetSubWorkflowTestRequestNil

`func (o *WorkflowTestRequest) SetSubWorkflowTestRequestNil(b bool)`

 SetSubWorkflowTestRequestNil sets the value for SubWorkflowTestRequest to be an explicit nil

### UnsetSubWorkflowTestRequest
`func (o *WorkflowTestRequest) UnsetSubWorkflowTestRequest()`

UnsetSubWorkflowTestRequest ensures that no value is present for SubWorkflowTestRequest, not even an explicit nil
### GetTaskRefToMockOutput

`func (o *WorkflowTestRequest) GetTaskRefToMockOutput() map[string]interface{}`

GetTaskRefToMockOutput returns the TaskRefToMockOutput field if non-nil, zero value otherwise.

### GetTaskRefToMockOutputOk

`func (o *WorkflowTestRequest) GetTaskRefToMockOutputOk() (*map[string]interface{}, bool)`
...
`func (o *WorkflowTestRequest) SetTaskRefToMockOutput(v map[string]interface{})`
...
### SetTaskRefToMockOutputNil

`func (o *WorkflowTestRequest) SetTaskRefToMockOutputNil(b bool)`

 SetTaskRefToMockOutputNil sets the value for TaskRefToMockOutput to be an explicit nil

### UnsetTaskRefToMockOutput
`func (o *WorkflowTestRequest) UnsetTaskRefToMockOutput()`

UnsetTaskRefToMockOutput ensures that no value is present for TaskRefToMockOutput, not even an explicit nil
### GetTaskToDomain
...
`func (o *WorkflowTestRequest) SetTaskToDomainNil(b bool)`

 SetTaskToDomainNil sets the value for TaskToDomain to be an explicit nil

### UnsetTaskToDomain
`func (o *WorkflowTestRequest) UnsetTaskToDomain()`
