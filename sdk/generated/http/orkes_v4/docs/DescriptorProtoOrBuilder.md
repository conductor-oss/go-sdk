...
**FieldList** | Pointer to **interface{}** |  | [optional] 
**FieldOrBuilderList** | Pointer to **interface{}** |  | [optional] 
...
`func (o *DescriptorProtoOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *DescriptorProtoOrBuilder) UnsetAllFields()`
...
`func (o *DescriptorProtoOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *DescriptorProtoOrBuilder) UnsetDefaultInstanceForType()`
...
`func (o *DescriptorProtoOrBuilder) GetFieldList() interface{}`

GetFieldList returns the FieldList field if non-nil, zero value otherwise.

### GetFieldListOk

`func (o *DescriptorProtoOrBuilder) GetFieldListOk() (*interface{}, bool)`
...
`func (o *DescriptorProtoOrBuilder) SetFieldList(v interface{})`
...
`func (o *DescriptorProtoOrBuilder) SetFieldListNil(b bool)`

 SetFieldListNil sets the value for FieldList to be an explicit nil

### UnsetFieldList
`func (o *DescriptorProtoOrBuilder) UnsetFieldList()`

UnsetFieldList ensures that no value is present for FieldList, not even an explicit nil
### GetFieldOrBuilderList

`func (o *DescriptorProtoOrBuilder) GetFieldOrBuilderList() interface{}`

GetFieldOrBuilderList returns the FieldOrBuilderList field if non-nil, zero value otherwise.

### GetFieldOrBuilderListOk

`func (o *DescriptorProtoOrBuilder) GetFieldOrBuilderListOk() (*interface{}, bool)`
...
`func (o *DescriptorProtoOrBuilder) SetFieldOrBuilderList(v interface{})`
...
### SetFieldOrBuilderListNil

`func (o *DescriptorProtoOrBuilder) SetFieldOrBuilderListNil(b bool)`

 SetFieldOrBuilderListNil sets the value for FieldOrBuilderList to be an explicit nil

### UnsetFieldOrBuilderList
`func (o *DescriptorProtoOrBuilder) UnsetFieldOrBuilderList()`

UnsetFieldOrBuilderList ensures that no value is present for FieldOrBuilderList, not even an explicit nil
