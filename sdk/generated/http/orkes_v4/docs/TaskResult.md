...
`func (o *TaskResult) SetOutputDataNil(b bool)`

 SetOutputDataNil sets the value for OutputData to be an explicit nil

### UnsetOutputData
`func (o *TaskResult) UnsetOutputData()`
...
`func (o *TaskResult) HasTaskId() bool`
...
`func (o *TaskResult) HasWorkflowInstanceId() bool`
