...
`func (o *ExtensionRangeOptions) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *ExtensionRangeOptions) UnsetAllFields()`
...
`func (o *ExtensionRangeOptions) SetAllFieldsRawNil(b bool)`

 SetAllFieldsRawNil sets the value for AllFieldsRaw to be an explicit nil

### UnsetAllFieldsRaw
`func (o *ExtensionRangeOptions) UnsetAllFieldsRaw()`
