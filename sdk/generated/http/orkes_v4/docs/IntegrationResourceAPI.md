...
[**GetTokenUsageForIntegration**](IntegrationResourceAPI.md#GetTokenUsageForIntegration) | **Get** /integrations/provider/{name}/integration/{integration_name}/metrics | Get Token Usage by Integration
[**GetTokenUsageForIntegrationProvider**](IntegrationResourceAPI.md#GetTokenUsageForIntegrationProvider) | **Get** /integrations/provider/{name}/metrics | Get Token Usage by Integration Provider
...
[**RegisterTokenUsage**](IntegrationResourceAPI.md#RegisterTokenUsage) | **Post** /integrations/provider/{name}/integration/{integration_name}/metrics | Register Token usage
...
## GetTokenUsageForIntegration

> int32 GetTokenUsageForIntegration(ctx, name, integrationName).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IntegrationResourceAPI.GetTokenUsageForIntegration(context.Background(), name, integrationName).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `IntegrationResourceAPI.GetTokenUsageForIntegration``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTokenUsageForIntegration`: int32
    fmt.Fprintf(os.Stdout, "Response from `IntegrationResourceAPI.GetTokenUsageForIntegration`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTokenUsageForIntegrationRequest struct via the builder pattern
...
## GetTokenUsageForIntegrationProvider

> map[string]string GetTokenUsageForIntegrationProvider(ctx, name).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IntegrationResourceAPI.GetTokenUsageForIntegrationProvider(context.Background(), name).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `IntegrationResourceAPI.GetTokenUsageForIntegrationProvider``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetTokenUsageForIntegrationProvider`: map[string]string
    fmt.Fprintf(os.Stdout, "Response from `IntegrationResourceAPI.GetTokenUsageForIntegrationProvider`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetTokenUsageForIntegrationProviderRequest struct via the builder pattern
...
> RegisterTokenUsage(ctx, name, integrationName).Body(body).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.IntegrationResourceAPI.RegisterTokenUsage(context.Background(), name, integrationName).Body(body).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `IntegrationResourceAPI.RegisterTokenUsage``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiRegisterTokenUsageRequest struct via the builder pattern
