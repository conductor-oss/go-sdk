...
[**SearchV2**](SchedulerResourceAPI.md#SearchV2) | **Get** /scheduler/search/executions | Search for workflows based on payload and other parameters
...
func main() {
    saveScheduleRequest := *openapiclient.NewSaveScheduleRequest(*openapiclient.NewStartWorkflowRequest("Name_example")) // SaveScheduleRequest | 
