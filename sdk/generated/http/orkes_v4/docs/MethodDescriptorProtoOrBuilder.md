...
`func (o *MethodDescriptorProtoOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *MethodDescriptorProtoOrBuilder) UnsetAllFields()`
...
`func (o *MethodDescriptorProtoOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *MethodDescriptorProtoOrBuilder) UnsetDefaultInstanceForType()`
