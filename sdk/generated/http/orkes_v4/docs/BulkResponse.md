...
------------ | ------------- | ------------- | -------------
**BulkErrorResults** | Pointer to  |  | [optional] 
...
### SetBulkErrorResultsNil

`func (o *BulkResponse) SetBulkErrorResultsNil(b bool)`

 SetBulkErrorResultsNil sets the value for BulkErrorResults to be an explicit nil

### UnsetBulkErrorResults
`func (o *BulkResponse) UnsetBulkErrorResults()`

UnsetBulkErrorResults ensures that no value is present for BulkErrorResults, not even an explicit nil
