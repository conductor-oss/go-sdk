...
`func (o *EnumValueOptions) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *EnumValueOptions) UnsetAllFields()`
...
`func (o *EnumValueOptions) SetAllFieldsRawNil(b bool)`

 SetAllFieldsRawNil sets the value for AllFieldsRaw to be an explicit nil

### UnsetAllFieldsRaw
`func (o *EnumValueOptions) UnsetAllFieldsRaw()`
