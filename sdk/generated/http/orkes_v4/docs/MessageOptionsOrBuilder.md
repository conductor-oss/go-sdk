...
`func (o *MessageOptionsOrBuilder) SetAllFieldsNil(b bool)`

 SetAllFieldsNil sets the value for AllFields to be an explicit nil

### UnsetAllFields
`func (o *MessageOptionsOrBuilder) UnsetAllFields()`
...
`func (o *MessageOptionsOrBuilder) SetDefaultInstanceForTypeNil(b bool)`

 SetDefaultInstanceForTypeNil sets the value for DefaultInstanceForType to be an explicit nil

### UnsetDefaultInstanceForType
`func (o *MessageOptionsOrBuilder) UnsetDefaultInstanceForType()`
