...
func main() {
    authorizationRequest := *openapiclient.NewAuthorizationRequest([]string{"Access_example"}, *openapiclient.NewSubjectRef(), *openapiclient.NewTargetRef("Type_example")) // AuthorizationRequest | 
