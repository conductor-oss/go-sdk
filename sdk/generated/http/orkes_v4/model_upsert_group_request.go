...
type UpsertGroupRequest struct {
	...
	DefaultAccess map[string]interface{} `json:"defaultAccess,omitempty"`
...
// GetDefaultAccess returns the DefaultAccess field value if set, zero value otherwise (both if not set or set to explicit null).
...
// SetDefaultAccess gets a reference to the given map[string]interface{} and assigns it to the DefaultAccess field.
