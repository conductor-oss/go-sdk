...
var _ MappedNullable = &ExtendedWorkflowDef{}
...
func (o ExtendedWorkflowDef) MarshalJSON() ([]byte, error) {
...
func (o ExtendedWorkflowDef) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedWorkflowDef struct {
	value *ExtendedWorkflowDef
	isSet bool
}

func (v NullableExtendedWorkflowDef) Get() *ExtendedWorkflowDef {
	return v.value
}

func (v *NullableExtendedWorkflowDef) Set(val *ExtendedWorkflowDef) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedWorkflowDef) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedWorkflowDef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedWorkflowDef(val *ExtendedWorkflowDef) *NullableExtendedWorkflowDef {
	return &NullableExtendedWorkflowDef{value: val, isSet: true}
}

func (v NullableExtendedWorkflowDef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedWorkflowDef) UnmarshalJSON(src []byte) error {
	v.isSet = true
