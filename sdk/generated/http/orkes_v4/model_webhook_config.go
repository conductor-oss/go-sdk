...
// GetReceiverWorkflowNamesToVersions returns the ReceiverWorkflowNamesToVersions field value if set, zero value otherwise (both if not set or set to explicit null).
...
func (o WebhookConfig) ToMap() (map[string]interface{}, error) {
	...
	if o.ReceiverWorkflowNamesToVersions != nil {
