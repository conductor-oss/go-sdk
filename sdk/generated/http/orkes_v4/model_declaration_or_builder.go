...
func (o *DeclarationOrBuilder) GetAllFields() map[string]interface{} {
	if o == nil {
...
func (o *DeclarationOrBuilder) GetAllFieldsOk() (*map[string]interface{}, bool) {
...
func (o *DeclarationOrBuilder) SetAllFields(v map[string]interface{}) {
	o.AllFields = v
}
