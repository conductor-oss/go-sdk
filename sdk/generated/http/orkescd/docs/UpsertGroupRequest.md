...
------------ | ------------- | ------------- | -------------
**DefaultAccess** | Pointer to **map[string][]string** | a default Map&lt;TargetType, Set&lt;Access&gt; to share permissions, allowed target types: WORKFLOW_DEF, TASK_DEF, WORKFLOW_SCHEDULE | [optional] 
