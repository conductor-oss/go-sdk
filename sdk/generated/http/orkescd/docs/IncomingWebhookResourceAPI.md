...
> string HandleWebhook(ctx, id).RequestParams(requestParams).Body(body).Execute()
...
func main() {
    ...
    resp, r, err := apiClient.IncomingWebhookResourceAPI.HandleWebhook(context.Background(), id).RequestParams(requestParams).Body(body).Execute()
    if err != nil {
...
> string HandleWebhook1(ctx, id).RequestParams(requestParams).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.IncomingWebhookResourceAPI.HandleWebhook1(context.Background(), id).RequestParams(requestParams).Execute()
    if err != nil {
