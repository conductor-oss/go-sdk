...
var _ MappedNullable = &ExtendedTaskDef{}
...
// SetBackoffScaleFactor gets a reference to the given int32 and assigns it to the BackoffScaleFactor field.
...
// GetOverwriteTags returns the OverwriteTags field value if set, zero value otherwise.
func (o *ExtendedTaskDef) GetOverwriteTags() bool {
	if o == nil || IsNil(o.OverwriteTags) {
		var ret bool
		return ret
	}
	return *o.OverwriteTags
}

// GetOverwriteTagsOk returns a tuple with the OverwriteTags field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExtendedTaskDef) GetOverwriteTagsOk() (*bool, bool) {
	if o == nil || IsNil(o.OverwriteTags) {
		return nil, false
	}
	return o.OverwriteTags, true
}
...
// SetOverwriteTags gets a reference to the given bool and assigns it to the OverwriteTags field.
...
// SetPollTimeoutSeconds gets a reference to the given int32 and assigns it to the PollTimeoutSeconds field.
...
// GetTotalTimeoutSeconds returns the TotalTimeoutSeconds field value
func (o *ExtendedTaskDef) GetTotalTimeoutSeconds() int64 {
	...
	return o.TotalTimeoutSeconds
}

// GetTotalTimeoutSecondsOk returns a tuple with the TotalTimeoutSeconds field value
// and a boolean to check if the value has been set.
func (o *ExtendedTaskDef) GetTotalTimeoutSecondsOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.TotalTimeoutSeconds, true
}

// SetTotalTimeoutSeconds sets field value
func (o *ExtendedTaskDef) SetTotalTimeoutSeconds(v int64) {
	o.TotalTimeoutSeconds = v
}
...
func (o ExtendedTaskDef) MarshalJSON() ([]byte, error) {
...
func (o ExtendedTaskDef) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OverwriteTags) {
		toSerialize["overwriteTags"] = o.OverwriteTags
	}
	if !IsNil(o.OwnerApp) {
	...
	toSerialize["totalTimeoutSeconds"] = o.TotalTimeoutSeconds
...
type NullableExtendedTaskDef struct {
	value *ExtendedTaskDef
	isSet bool
}

func (v NullableExtendedTaskDef) Get() *ExtendedTaskDef {
	return v.value
}

func (v *NullableExtendedTaskDef) Set(val *ExtendedTaskDef) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedTaskDef) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedTaskDef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedTaskDef(val *ExtendedTaskDef) *NullableExtendedTaskDef {
	return &NullableExtendedTaskDef{value: val, isSet: true}
}

func (v NullableExtendedTaskDef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedTaskDef) UnmarshalJSON(src []byte) error {
	v.isSet = true
