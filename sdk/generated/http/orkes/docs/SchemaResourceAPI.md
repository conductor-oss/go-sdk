...
[**GetSchemaByNameWithLatestVersion**](SchemaResourceAPI.md#GetSchemaByNameWithLatestVersion) | **Get** /schema/{name} | Get schema by name with latest version
...
> []SchemaDef GetAllSchemas(ctx).Short(short).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SchemaResourceAPI.GetAllSchemas(context.Background()).Short(short).Execute()
    if err != nil {
...
> SchemaDef GetSchemaByNameWithLatestVersion(ctx, name).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SchemaResourceAPI.GetSchemaByNameWithLatestVersion(context.Background(), name).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SchemaResourceAPI.GetSchemaByNameWithLatestVersion``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetSchemaByNameWithLatestVersion`: SchemaDef
    fmt.Fprintf(os.Stdout, "Response from `SchemaResourceAPI.GetSchemaByNameWithLatestVersion`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSchemaByNameWithLatestVersionRequest struct via the builder pattern
