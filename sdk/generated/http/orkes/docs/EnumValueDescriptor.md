...
------------ | ------------- | ------------- | -------------
**File** | Pointer to **map[string]interface{}** | Simplified schema for FileDescriptor (original had circular references) | [optional] 
...
**Type** | Pointer to **map[string]interface{}** | Simplified schema for EnumDescriptor (original had circular references) | [optional] 
