...
// HumanTaskApiService is the service for the human task resource.
...
// HumanTaskApiGetTask1Opts is the optional parameters for the GetTask method
...
// Deprecated: Use DeleteTaskFromHumanTaskRecordsByTaskID instead.
...
// DeleteTemplatesByNameAndVersion deletes templates by name and versions.
...
func (a *HumanTaskApiService) GetTask1(ctx context.Context, taskId string, optionals *HumanTaskApiGetTask1Opts) (human.HumanTaskEntry, *http.Response, error) {
	return a.GetTask(ctx, taskId, optionals)
}

// GetTask gets a task by task ID.
func (a *HumanTaskApiService) GetTask(ctx context.Context, taskId string, optionals *HumanTaskApiGetTask1Opts) (human.HumanTaskEntry, *http.Response, error) {
