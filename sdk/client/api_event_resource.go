...
// NewEventResourceApiService creates a service from existing APIClient
func NewEventResourceApiService(apiClient *APIClient) *EventResourceApiService {
	if apiClient == nil {
		return nil
	}

	return &EventResourceApiService{
		APIClient: apiClient,
	}
}
...
func (a *EventResourceApiService) GetQueueConfig(ctx context.Context, queueType string, queueName string) (map[string]interface{}, *http.Response, error) {
	...
	// Convert map[string]map[string]interface{} to map[string]interface{} if needed
...
func (a *EventResourceApiService) GetQueueNames(ctx context.Context) (map[string]interface{}, *http.Response, error) {
	...
	return interfaceResult, resp, nil
}
