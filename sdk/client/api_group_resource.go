...
// GroupResourceApiService
type GroupResourceApiService struct {
	*APIClient
}

// NewGroupResourceApiService creates a new GroupResourceApiService instance
func NewGroupResourceApiService(apiClient *APIClient) *GroupResourceApiService {
	return &GroupResourceApiService{APIClient: apiClient}
}
