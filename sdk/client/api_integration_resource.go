...
// IntegrationResourceApiService is the service for the integration resource.
...
func (a *IntegrationResourceApiService) GetTagsForIntegrationProvider(ctx context.Context, name string) ([]model.TagObject, *http.Response, error) {
	...
	// Convert tags to TagObject using mapper
	result := toDomainTagObjectsFromGenerated(tags)
...
func (a *IntegrationResourceApiService) UpdateTagForIntegrationProvider(ctx context.Context, tags []model.TagObject, name string) (*http.Response, error) {
	// Convert domain tags to generated tags using mapper
	genTags := toGeneratedTagsFromTagObjects(tags)
...
func (a *IntegrationResourceApiService) RegisterTokenUsage(ctx context.Context, integrationName string, modelName string, tokenUsage int32) (*http.Response, error) {
