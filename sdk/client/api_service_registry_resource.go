...
// ServiceRegistryResourceApiService is the service for the ServiceRegistryResourceAPI
type ServiceRegistryResourceApiService struct {
	*APIClient
}

// NewServiceRegistryResourceApiService creates a new ServiceRegistryResourceApiService instance
func NewServiceRegistryResourceApiService(client *APIClient) *ServiceRegistryResourceApiService {
	return &ServiceRegistryResourceApiService{APIClient: client}
}
