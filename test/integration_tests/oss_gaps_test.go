...
const (
	...
	ossGapGetWorkflowTask = "the GET_WORKFLOW system task is not executed on plain OSS Conductor, confirmed empirically (task stays SCHEDULED forever, no worker picks it up)"
